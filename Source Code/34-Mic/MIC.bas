...
'-----------------------
'-----------------------[Variables]
Dim Mic As Word , Channel As Byte , Last_mic As Word
'-----------------------[Constants]
Const V_ref = 5
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
'--->[Main Program]
Cursor Off Noblink : Enable Interrupts : Enable Adc : Print "Start"
Cls
Lcd "start"
Do
   Gosub Read_adc : Gosub Display_level
Loop
End
'---<[End Main]
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Read_adc:
   Channel = 1 : Start Adc : Idle : Stop Adc
Return
'-----------------------
'--->[Read ADC Input Values]
Adc_isr:
...
Display_level:
   If Mic <> 0 Then
      If Mic > Last_mic Then
         Cls : Lcd Mic : Last_mic = Mic
      End If
      Print Mic
   End If
Return
